...
{
    public class VehicleResult : IVehicle
    {
        ...
        public void ConvertVINResult( VINResultModel result )
        {
            CurbWeightLB = NumberParser.Parse<int>(result.CurbWeightLB);
            DisplacementCI = NumberParser.Parse<double>(result.DisplacementCI);
            DisplacementL = NumberParser.Parse<double>(result.DisplacementL);
            Doors = NumberParser.Parse<int>(result.Doors);
            EngineCylinders = NumberParser.Parse<int>(result.EngineCylinders);
            EngineHP = NumberParser.Parse<double>(result.EngineHP);
            EngineKW = NumberParser.Parse<double>(result.EngineKW);
            ManufacturerId = NumberParser.Parse<int>(result.ManufacturerId);
            ModelYear = NumberParser.Parse<int>(result.ModelYear);
            TransmissionSpeeds = NumberParser.Parse<int>(result.TransmissionSpeeds);
        }
